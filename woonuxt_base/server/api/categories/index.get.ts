	...
	return [
		{
			node: {
				...
				image: {
					sourceUrl:
						"https://via.placeholder.com/300x200.png?text=Fine+Line+Tattoo",
		...
		},
		{
			node: {
				...
				image: {
					sourceUrl:
						"https://via.placeholder.com/300x200.png?text=Blackwork+Tattoo",
		...
		},
		{
			node: {
				...
				image: {
					sourceUrl:
						"https://via.placeholder.com/300x200.png?text=Script+Tattoo",
		...
		},
		{
			node: {
				...
				image: {
					sourceUrl:
						"https://via.placeholder.com/300x200.png?text=Minimalist+Tattoo",
		...
		},
		{
			node: {
				...
				image: {
					sourceUrl:
						"https://via.placeholder.com/300x200.png?text=Geometric+Tattoo",
