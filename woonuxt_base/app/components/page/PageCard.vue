...
const config = {
	...
	title:
		"text-gray-900 dark:text-white text-base font-semibold truncate flex items-center gap-1.5",
...
<template>
  <UCard v-bind="attrs" :class="[ui.wrapper, to && ui.to]" :ui="ui">
    <NuxtLink class="focus:outline-none" v-if="to" v-bind="nuxtLinkBind" :aria-label="ariaLabel" tabindex="-1">
