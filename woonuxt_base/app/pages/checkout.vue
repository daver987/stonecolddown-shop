...
useSeoMeta({
	...
	description:
		"Complete your purchase at Stone Cold Down. Securely checkout with our trusted payment gateway.",
	ogTitle: "Checkout | Stone Cold Down",
	ogDescription:
		"Securely checkout with our trusted payment gateway at Stone Cold Down.",
...
const stripe: Stripe | null = stripeKey
	? await loadStripe(stripeKey as string)
	: null;
const elements = ref();
