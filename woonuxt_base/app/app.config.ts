...
export default defineAppConfig({
	...
	shortDescription:
		"Explore the distinctive fine line black and grey tattoos by Natasha Smith",
	description:
	...
	siteImage:
		"https://res.cloudinary.com/dks0sw9qh/images/v1720247926/cropped-scd_logo_/cropped-scd_logo_.jpg?_i=AA",
	storeSettings: {
		autoOpenCart: false,
		showReviews: true,
		showFilters: true,
