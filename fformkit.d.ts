import type * as _formkit_core from '@formkit/core'
import type {
  FormKitLibrary,
  FormKitPlugin,
  FormKitGroupValue,
 ...
 * @public
 */
declare function createLibraryPlugin(
...
interface FormKitInputProps<Props extends FormKitInputs<Props>> {
  ...
  _: {
    type?:
      | (Props['type'] extends FormKitTypeDefinition<unknown>
          ? Props['type']
          : never & {})
 ...
 * @public
 */
type MergedEvents<Props extends FormKitInputs<Props>> =
 ...
 * @public
 */
type FormKitInputs<Props extends FormKitInputs<Props>> =
...
interface FormKitInputEvents<Props extends FormKitInputs<Props>> {
  form: {
    (event: 'submit-raw', e: Event, node: FormKitNode): unknown
    (event: 'submit-invalid', node: FormKitNode): unknown
    (event: 'submit', data: unknown, node: FormKitNode): unknown
  }
}
/**
 ...
 * @public
 */
type FormKitOptionsValue<Options> = Options extends FormKitOptionsProp
...
interface FormKitBaseEvents<Props extends FormKitInputs<Props>> {
  (event: 'input', value: PropType<Props, 'value'>, node: FormKitNode): unknown
  (
    event: 'inputRaw',
  ...
  (event: 'update:modelValue', value: PropType<Props, 'value'>): unknown
  (event: 'update:model-value', value: PropType<Props, 'value'>): unknown
  (event: 'node', node: FormKitNode): unknown
}
/**
...
interface FormKitEventsAsProps {
  onInput: (value: unknown, node: FormKitNode) => unknown
  onInputRaw: (value: unknown, node: FormKitNode) => unknown
  'onUpdate:modelValue': (value: unknown, node: FormKitNode) => unknown
  onNode: (node: FormKitNode) => unknown
}
/**
...
interface FormKitInputEventsAsProps<Props extends FormKitInputs<Props>> {
  form: {
    onSubmitRaw: (e: Event, node: FormKitNode) => unknown
    onSubmitInvalid: (node: FormKitNode) => unknown
    onSubmit: (data: unknown, node: FormKitNode) => unknown
  }
}
/**
 ...
 * @public
 */
type FormKitSlotData<
  Props extends FormKitInputs<Props>,
  E extends Record<string, unknown> = Record<never, never>,
> = (context: FormKitFrameworkContext<PropType<Props, 'value'>> & E) => unknown
/**
 ...
 * @public
 */
interface FormKitTextSlots<Props extends FormKitInputs<Props>>
 ...
 * @public
 */
interface FormKitSelectSlots<Props extends FormKitInputs<Props>>
  extends FormKitBaseSlots<Props> {
 ...
 * @public
 */
interface FormKitCheckboxSlots<Props extends FormKitInputs<Props>>
  extends FormKitBaseSlots<Props> {
 ...
 * @public
 */
interface FormKitFileSlots<Props extends FormKitInputs<Props>>
  extends FormKitBaseSlots<Props> {
  fileList: FormKitSlotData<Props>
  fileItem: FormKitSlotData<Props>
  fileItemIcon: FormKitSlotData<
    Props,
    {
      file: FormKitFile
    }
  >
  fileName: FormKitSlotData<
    Props,
    {
      file: FormKitFile
    }
  >
  fileRemove: FormKitSlotData<
    Props,
    {
      file: FormKitFile
    }
  >
  fileRemoveIcon: FormKitSlotData<
    Props,
    {
      file: FormKitFile
    }
 ...
 * @public
 */
type FormKitButtonSlots<Props extends FormKitInputs<Props>> = Omit<
 ...
 * @public
 */
type FormKitOptionsListWithGroups = Array<
 ...
 * @public
 */
type FormKitOptionsListWithGroupsProp = Array<
 ...
 * @public
 */
type FormKitOptionsPropWithGroups =
  | FormKitOptionsProp
...
interface FormKitRuntimeProps<Props extends FormKitInputs<Props>, V = unknown> {
  ...
  validationMessages: Record<
    string,
    | string
    | ((ctx: { node: FormKitNode; name: string; args: unknown[] }) => string)
  >
  /**
  ...
  validationRules: Record<
    string,
    (node: FormKitNode, ...args: unknown[]) => boolean | Promise<boolean>
  >
  /**
 ...
 * @public
 */
declare function isGroupOption(
  option:
    | FormKitOptionsItem
 ...
 * @public
 */
declare function normalizeOptions<T extends FormKitOptionsPropWithGroups>(
  options: T,
  i?: {
    count: number
  }
 ...
 * @public
 */
declare function createSection(
  section: string,
 ...
 * @public
 */
declare function eachSection<T>(
  schema: FormKitSchemaDefinition,
  callback: (
...
export {
  ...
  $root,
  type AllReals,
  type FormKitBaseEvents,
  type FormKitBaseProps,
  type FormKitBaseSlots,
  type FormKitBoxSlots,
  type FormKitButtonSlots,
  type FormKitCheckboxSlots,
  type FormKitConditionalProps,
  type FormKitEvents,
  type FormKitEventsAsProps,
  type FormKitFile,
  type FormKitFileSlots,
  type FormKitFileValue,
  type FormKitInputEvents,
  type FormKitInputEventsAsProps,
  type FormKitInputProps,
  type FormKitInputSchema,
  type FormKitInputSlots,
  type FormKitInputs,
  type FormKitOptionsGroupItem,
  type FormKitOptionsGroupItemProp,
  type FormKitOptionsItem,
  type FormKitOptionsList,
  type FormKitOptionsListWithGroups,
  type FormKitOptionsListWithGroupsProp,
  type FormKitOptionsProp,
  type FormKitOptionsPropExtensions,
  type FormKitOptionsPropWithGroups,
  type FormKitOptionsValue,
  type FormKitRuntimeProps,
  type FormKitSchemaExtendableSection,
  type FormKitSchemaSection,
  type FormKitSection,
  type FormKitSelectSlots,
  type FormKitSlotData,
  type FormKitTextSlots,
  type InputType,
  type MergedEvents,
  type MergedProps,
  type OptionSlotData,
