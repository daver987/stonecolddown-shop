 ...
 *
 * @checksum - 15842ce5af9660050725fcd92a32b6a97f44c1b0bcd3dfc2fe7a533e217dec84
 * @variables - radius=rounded-lg,accentColor=blue,colorTemperature=zinc,spacing=1.5,scale=sm,inputShadow=shadow,baseColorShade=500,borderShadeLightMode=300,borderShadeDarkMode=400,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
 * @theme - regenesis
 **/
...
const classes = {
  ...
  'family:button__input': {
    ...
    flex: true,
    '!text-xs': true,
    'px-[calc(theme(spacing[3.5])-1px)]': true,
    'py-[calc(theme(spacing[2.5])-1px)]': true,
    'items-center': true,
    'mb-1': true,
    'text-xs': true,
    'ring-offset-1': true,
  ...
  submit__input: {
    ...
    'group-data-[loading=true]/form:before:border-1': true,
  ...
  rating__ratingItem: {
    ...
    'focus-within:outline-blue-500': true,
    'w-[1.5em]': true,
    'h-[1.5em]': true,
  },
  ...
  'multi-step__tab': {
    ...
    'dark:group-data-[tab-style=progress]/wrapper:before:border-zinc-500': true,
    ...
    'group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-blue-500':
      true,
    ...
    'dark:group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-blue-500':
      true,
  },
